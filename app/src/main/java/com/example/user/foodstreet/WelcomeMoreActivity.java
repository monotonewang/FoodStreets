...
import com.example.user.foodstreet.adapter.WelcomeMoreVPAdapter;
 ...
 */
public class WelcomeMoreActivity extends BaseActivity {
    @Bind(R.id.activity_welcomemore_vp)
    public ViewPager viewPager;
    private List<Bitmap> bitmapList;
    private String TAG="WelcomeMoreActivity";
    ...
    protected void init() {
        ...
        WelcomeMoreVPAdapter welcomeMoreVPAdapter=new WelcomeMoreVPAdapter(this,bitmapList);
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                Log.e(TAG, "onPageScrolled: " + "position=" + position + "positionoffset=" + positionOffset + "positionOffsetPixels=" + positionOffsetPixels);
                  ...
                  if(position==3&&positionOffsetPixels>widthPixels/2){
                    Intent intent=new Intent(WelcomeMoreActivity.this,MainActivity.class);
