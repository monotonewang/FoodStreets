...
import com.example.user.foodstreet.fragment.RecommendFragment;
...
//                Log.e(TAG, "onClick: "+"==rec" );
                    getSupportFragmentManager().beginTransaction().replace(R.id.activity_main_fl,new RecommendFragment()).commit();
                break;
