...
import com.example.user.foodstreet.adapter.RecommedFragmentLVAdapter;
import com.example.user.foodstreet.base.BaseFragment;
import com.example.user.foodstreet.custem.PullToRefreshView;
import com.example.user.foodstreet.custem.RecommemdFragmentLVztView;
import com.example.user.foodstreet.custem.RecommendFragmentDivisionView;
import com.example.user.foodstreet.custem.RecommendFragmentFenLeiView;
import com.example.user.foodstreet.custem.RecommendFragmentTop3VPView;
import com.example.user.foodstreet.custem.RecommendFragmentVPView;
import com.example.user.foodstreet.model.RecommendFoodModel;
import com.example.user.foodstreet.util.Constants;
import com.example.user.foodstreet.util.JsonUtil;
 ...
 */
public class RecommendFragment extends BaseFragment implements OkHttpUtil.OnDownDataListener, AdapterView.OnItemClickListener {
