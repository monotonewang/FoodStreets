...
public abstract class AbsBaseAdapter_more<T> extends BaseAdapter {
	private String TAG="AbsBaseAdapter_more";
...
//			Log.e(TAG, "getView: "+"0"+resid[getItemViewType(0)]+"1"+ resid[getItemViewType(1)]+"reslength"+resid.length);
	...
	/**
	 * 返回当前position所对应的Item的类型，必须从0开始，依次递增 1、谁继承谁实现 2、前提条件 --
	 * 强制要求数据源中有一个type名称的属性，通过反射得到该属性
	 */
	@Override
...
//				Log.e(TAG, "getView: "+"id="+id+"layout"+layoutView+"view"+view+"" );
...
//			Log.e(TAG, "bindTextView: "+""+tv+"="+text+"id="+id );
			tv.setText(text);
			return this;
		}
