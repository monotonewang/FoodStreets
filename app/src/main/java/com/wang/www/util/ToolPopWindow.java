...
public class ToolPopWindow {
	//attach location
	public static final int ATTACH_LOCATION_WINDOW = 1;
	public static final int ATTACH_LOCATION_VIEW = 2;
	
	private PopupWindow mPopupWindow;
	private static ToolPopWindow INSTANCE;
	
	private ToolPopWindow(){}
	private ToolPopWindow(Context context){
		this.mPopupWindow = new PopupWindow(context);
	}
	public static ToolPopWindow getInstance(Context context){
		if(INSTANCE == null){
			INSTANCE = new ToolPopWindow(context);
		}
		return INSTANCE;
	}
	/**
	 ...
	 * @return
	 */
	public ToolPopWindow init(int height,int width){
...
//      mPopupWindow.setWidth(LayoutParams.MATCH_PARENT);  
	...
	public ToolPopWindow showPopWindow(View contentView, int location, View attachContainer, int x, int y){
	 ...
	 * @return
	public ToolPopWindow showPopWindow(View contentView,int location,View attachContainer){
		mPopupWindow.setContentView(contentView);
		mPopupWindow.setHeight(LayoutParams.WRAP_CONTENT);  
